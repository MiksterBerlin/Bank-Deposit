...
Goal: 
This dataset was used to compare different classification models to optain the best possible features to improve the subscription to term deposits by bank clients.
